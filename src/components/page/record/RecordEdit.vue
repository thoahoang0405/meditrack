    ...
    <div class="form">
      ...
      <div class="tab">
        <div v-for="item in listTab" :key="item.tabId">
          <div
            @click="tabClick(item)"
            :class="item.tabId == showTabActive ? 'tab-active' : ''"
            class="tab-item"
          >
            {{ item.tabName }}
          </div>
      ...
      <div class="form-main">
        <div class="form-records" v-if="showTabActive == 1">
        ...
        <div class="form-treats" v-if="showTabActive == 3">
          <div class="group-controll">
        ...
        <div class="form-tests" v-if="showTabActive == 2">
          <div class="detail mt-2">
            <div class="table-detail">
              <div class="header-table mb-1">
                ...
                <div class="item-table mr-2" style="min-width: 88px">
                  Đơn vị
                </div>
              ...
              >
                ...
                <div class="function-table-detail function-table">
                  ...
                  <div
                    v-if="records.MedicalTests.length > 1"
...
.tab-active {
  border-bottom: 3px solid #07b6c4;
  color: #07b6c4;
  font-weight: bold;
}
</style>
