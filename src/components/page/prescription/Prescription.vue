          ...
          <table keyup.up="onKeyUpTable">
            <thead>
              <tr>
                ...
                <th v-if="model.user!=1">{{ tableInfo.UsedName }}</th>
...
import MSFunction from "/meditrack/meditrack/src/js/common/function";
import { Table } from "/meditrack/meditrack/src/js/common/table";
import {
  FormDetailMode,
  CloseST,
} from "/meditrack/meditrack/src/js/common/enumeration";
import {
  ErrorMsg,
  btnPopup,
  TitlePopup,
  NoticeMsg,
} from "/meditrack/meditrack/src/js/common/resource";
export default {
  components: {
    Paginate,
  },
